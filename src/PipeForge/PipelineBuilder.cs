...
public class PipelineBuilder<TContext> where TContext : class
{
    private readonly IServiceCollection _services = new ServiceCollection();

    // The constructor is intentionally internal to enforce the use of the
    // static Pipeline.CreateFor<TContext> method.
    internal PipelineBuilder(ILoggerFactory? loggerFactory = null)
    {

...
public static class AddPipelineStepExtensions
{
    ...
    {
        var typeDescriptor = TypeDescriptor.Create(typeof(TStep));
    ...
    {
        var typeDescriptor = TypeDescriptor.Create<TStepInterface>(typeof(TStep));
        return services.AddPipelineStep(typeDescriptor, lifetime);
    }

    private static IServiceCollection AddPipelineStep(this IServiceCollection services, TypeDescriptor typeDescriptor, ServiceLifetime lifetime)
    {

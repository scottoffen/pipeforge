...
internal sealed class StepTypeDescriptor
{
    ...
    private static readonly string _openGenericPipelineStepTypeName = _openGenericPipelineStepType.FullName ?? _openGenericPipelineStepType.Name;
    ...
    public static StepTypeDescriptor Create<TStepInterface>(Type type)
    {
        ...
        if (!typeof(TStepInterface).IsAssignableFrom(type))
        {
            ...
            var interfaceTypeName = interfaceType.FullName ?? interfaceType.Name;
            throw new ArgumentException(string.Format(ArgumentExceptionMessage, name, interfaceTypeName));
        }
    ...
    public static StepTypeDescriptor Create(Type type)
    {
        ...
        var interfaceType = type.GetInterfaces()
            ...
            ?? throw new ArgumentException(string.Format(ArgumentExceptionMessage, name, _openGenericPipelineStepTypeName));
